...
item modify entity @s contents [{"function":"set_name","name":{"text":"Clone Schematic"},"target":"item_name"},{"function":"set_lore","entity":"this","lore":[{"text":"Consumed by a Clone Paste","italic":false,"color":"gray"}],"mode":"replace_section","offset":0,"size":1}]
