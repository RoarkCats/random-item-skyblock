execute if score shulker_dupe ris.settings matches 1 run advancement grant @p[distance=..16] only ris:alchemy/transmutation/1_shulker_2_shulker
...
execute if score rng ris.rng matches 2.. run advancement grant @p[distance=..16] only ris:alchemy/transmutation/1_shulker_2_shulker
