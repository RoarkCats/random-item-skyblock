...
scoreboard players reset #double ris.timer
...
scoreboard players reset #command ris.timer
...
scoreboard players reset #structure ris.timer
...
scoreboard players reset #jigsaw ris.timer
...
scoreboard players reset #debug ris.timer
...
scoreboard players reset #knowledge ris.timer
