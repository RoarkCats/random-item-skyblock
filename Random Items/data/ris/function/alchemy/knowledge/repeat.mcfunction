...
execute align xyz run summon area_effect_cloud ~0.5 ~0.85 ~0.5 {Tags:["ris.alchemy_generator","ris.knowledge_generator"],Duration:2147000000,CustomName:'{"text":"Knowledge Generator"}'}
