...
execute unless items entity @s contents *[count=1] run return run function ris:alchemy/knowledge/chain/swap
...
execute if score rng1 ris.rng <= trade_multiply_chance ris.settings run data modify storage ris:random trades[0].sell set from entity @s Item