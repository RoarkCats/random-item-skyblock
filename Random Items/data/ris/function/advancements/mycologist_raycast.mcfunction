execute if block ~ ~ ~ brown_mushroom_block run advancement grant @s only ris:mycologist brown_mushroom
execute if block ~ ~ ~ red_mushroom_block run advancement grant @s only ris:mycologist red_mushroom
