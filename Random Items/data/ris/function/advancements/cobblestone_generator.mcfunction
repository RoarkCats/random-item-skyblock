...
execute if score @n[type=marker,tag=ris.cobble_gen,distance=..4] ris.mined_cobblestone matches 32.. run advancement grant @s only ris:ris/liquid_at_last/cobblestone_generator
