...
execute unless score item_giver ris.settings matches 0 if score same_items ris.settings matches 1 if score time ris.timer >= delay ris.timer as @r run loot give @a[tag=!ris.non_receiver,gamemode=!spectator,nbt=!{Health:0f}] loot ris:random_item
