...
tellraw @a [{"text":"Welcome to Random Item Skyblock v2.7!","color":"gold","bold":true,"hoverEvent":{"action":"show_text","value":{"text":"","extra":[{"text":"Made by RoarkCats, Ziplaw, and PhoenixSC","color":"gold"}]}}}]
