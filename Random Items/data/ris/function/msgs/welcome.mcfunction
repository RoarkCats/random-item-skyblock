...
tellraw @s ["<RoarkCats> To individually disable or re-enable your flow of items, anyone can click or run ",{"text":"[","color":"gray","shadow_color":[0,0,0,0.8]},{"text":"/trigger ris.receive_items","color":"aqua","clickEvent":{"action":"suggest_command","value":"/trigger ris.receive_items"},"hoverEvent":{"action":"show_text","value":["",{"text":"Toggle Personal Item Flow","color":"aqua"}]}},{"text":"]","color":"gray","shadow_color":[0,0,0,0.8]}]
