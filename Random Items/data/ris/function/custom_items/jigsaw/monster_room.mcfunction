...
execute if score #entrance_chosen ris.rng matches 0 positioned ~4 ~ ~ if entity @p[distance=..5] store success score #entrance_chosen ris.rng run fill ~ ~ ~ ~-4 ~1 ~ air replace stone
execute if score #entrance_chosen ris.rng matches 0 positioned ~-4 ~ ~ if entity @p[distance=..5] store success score #entrance_chosen ris.rng run fill ~ ~ ~ ~4 ~1 ~ air replace stone
execute if score #entrance_chosen ris.rng matches 0 positioned ~ ~ ~4 if entity @p[distance=..5] store success score #entrance_chosen ris.rng run fill ~ ~ ~ ~ ~1 ~-4 air replace stone
