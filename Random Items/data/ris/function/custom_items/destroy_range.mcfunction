...
execute if items entity @s weapon.mainhand debug_stick[!custom_data~{ris:{transmuted:1b}}] run return 0
...
execute if score jigsaw ris.special_item_settings matches 1 if items entity @s weapon.mainhand jigsaw run data merge storage ris:destroy_range {cube:{x:14,y:14,z:14, dx:32,dy:32,dz:32, ox:0,oy:0.5,oz:0, p:25, m:0}}
execute if items entity @s weapon.mainhand jigsaw[custom_data~{ris:{function:"double/jigsaw"}}] run return 0
execute if items entity @s weapon.mainhand jigsaw[custom_data~{ris:{function:"jigsaw/structure"}}] run data merge storage ris:destroy_range {cube:{x:1.7,y:1.7,z:1.7, dx:3.4,dy:3.4,dz:3.4, ox:0,oy:0.5,oz:0, p:4, m:0}}
execute if items entity @s weapon.mainhand jigsaw[custom_data~{ris:{function:"jigsaw/minecart"}}] run data merge storage ris:destroy_range {cube:{x:1.7,y:1.7,z:1.7, dx:3.4,dy:3.4,dz:3.4, ox:0,oy:0.5,oz:0, p:4, m:0}}
execute if items entity @s weapon.mainhand jigsaw[custom_data~{ris:{function:"jigsaw/command"}}] run data merge storage ris:destroy_range {cube:{x:2.2,y:2.2,z:2.2, dx:4.4,dy:4.4,dz:4.4, ox:0,oy:0.5,oz:0, p:5, m:0}}
execute if items entity @s weapon.mainhand jigsaw[custom_data~{ris:{function:"jigsaw/chain"}}] run return 0
execute if items entity @s weapon.mainhand repeating_command_block[custom_data~{ris:{function:"jigsaw/repeat"}}] run data merge storage ris:destroy_range {cube:{x:14,y:14,z:14, dx:32,dy:32,dz:32, ox:0,oy:0.5,oz:0, p:25, m:0}}
execute if items entity @s weapon.mainhand structure_block[custom_data~{ris:{function:"double/structure"}}] run data merge storage ris:destroy_range {cube:{x:70,y:70,z:70, dx:150,dy:150,dz:150, ox:0,oy:0.5,oz:0, p:40, m:0}}
execute if items entity @s weapon.mainhand structure_block[custom_data~{ris:{function:"structure/minecart"}}] run data merge storage ris:destroy_range {cube:{x:1.2,y:1.2,z:1.2, dx:2.4,dy:2.4,dz:2.4, ox:0,oy:0.5,oz:0, p:2, m:0}}
execute if items entity @s weapon.mainhand structure_block[custom_data~{ris:{function:"structure/command"}}] run data merge storage ris:destroy_range {cube:{x:1.7,y:1.7,z:1.7, dx:3.4,dy:3.4,dz:3.4, ox:0,oy:0.5,oz:0, p:4, m:0}}
