...
execute unless entity @r[tag=given] if score give item_timer >= give_item item_timer run execute store result score rng item_timer run loot insert 0 255 0 loot ris:rng
tag @r add sameGive
